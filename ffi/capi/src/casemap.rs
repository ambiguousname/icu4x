...
pub mod ffi {
    ...
    #[diplomat::attr(any(dart, js, demo_gen), rename = "TitlecaseOptions")]
    ...
    impl CaseMapper {
        ...
        #[diplomat::attr(any(dart, js, demo_gen), rename = "titlecaseSegmentWithOnlyCaseData")]
    ...
    impl TitlecaseMapper {
        ...
        #[diplomat::attr(any(dart, js, demo_gen), rename = "titlecaseSegment")]
